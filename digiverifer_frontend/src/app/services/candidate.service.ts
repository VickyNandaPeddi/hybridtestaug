...
export class CandidateService {
  ...
  suspectEmpCheck(companyName: any, orgId: any) {
    return this.http.get(`${environment.apiUrl}/api/candidate/suspectEmpMasterCheck/${companyName}/${orgId}`)
  }
  ...
  getAllSuspectEmpListtt(organizationId: any){
    console.log(organizationId,"======================............")
    return this.http.get(`${environment.apiUrl}/api/candidate/getAllSuspectEmpList/${organizationId}`,organizationId);
  }

  deleteSuspectExpById(id:any){
    console.log(".......................======================............",id)
    return this.http.put(`${environment.apiUrl}/api/candidate/deleteSuspectExpById/${id}`, id);
  }

  deleteSuspectEmployers(data:any){
    console.warn("delEmp:::",data);
    return this.http.post(`${environment.apiUrl}/api/candidate/deleteSuspectExp`, data);
  }


  updateSpectEMPloyee(data:any){
    return this.http.put(`${environment.apiUrl}/api/candidate/updateSpectEMPloyee`, data);
  }

  updateOrgScopeColor(data:any){
    return this.http.put(`${environment.apiUrl}/api/candidate/updateCandidateOrganisationScope`, data);
  }
}
